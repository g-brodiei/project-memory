...
Claude Code plugin for structured documentation bootstrapping, session-end learning capture, and documentation health auditing.
...
- [tech-stack.md](.claude-docs/reference/tech-stack.md) - Plugin system, manifest formats, installation
